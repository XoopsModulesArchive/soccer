...
$modversion['tables'][0] = "soccer_deductedpoints";
$modversion['tables'][1] = "soccer_leaguematches";
$modversion['tables'][2] = "soccer_opponents";
$modversion['tables'][3] = "soccer_seasonnames";
...
global $xoopsDB;
$get_seasons = $xoopsDB->query("SELECT SeasonID, SeasonName FROM ".$xoopsDB->prefix("soccer_seasonnames")." WHERE SeasonPublish = '1' ORDER BY SeasonName");
