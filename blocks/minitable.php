...
function b_minitable_show( ) {
    ...
    $module =& $module_handler->getByDirname('soccer');
    ...
    $get_deduct = $xoopsDB->query("SELECT points, teamid FROM ".$xoopsDB->prefix("soccer_deductedpoints")." WHERE seasonid = '$season_id'");
    ...
    $block['content'] .= "</table><br><div align=\"center\"><a href=\"".XOOPS_URL."/modules/soccer/index.php\">"._BL_GOTOMAIN."</a></div></marquee>";
    return $block;
}
?>