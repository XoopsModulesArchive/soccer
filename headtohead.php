...
if (!isset($_SESSION['defaulthomeid'])) {
    $sql = "SELECT OpponentID FROM ".$xoopsDB->prefix("soccer_opponents")." LIMIT 0,2";
...
FROM ".$xoopsDB->prefix("soccer_opponents")." O, ".$xoopsDB->prefix("soccer_opponents")." OP
WHERE
...
<td>
	...
	LM.LeagueMatchAwayGoals AS awaygoals
	FROM
	".$xoopsDB->prefix("soccer_leaguematches")." AS LM,
	".$xoopsDB->prefix("soccer_opponents")." O,
	".$xoopsDB->prefix("soccer_opponents")." OP
	WHERE
